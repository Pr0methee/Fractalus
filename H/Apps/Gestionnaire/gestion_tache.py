...
class GestionApps(PopingToplevel):
    ...
    def open(self,proc_name):
        ...
        if proc_name in self.d:
            if self.instances[proc_name] == []:
                ...
                self.draw_vignette(len([proc for proc in self.d if self.instances[proc]!=[]]),proc_name)
    ...
    def show(self,master):
        ...
        self.geometry("200x200+20+"+str(master.CANVAS.winfo_height()-258))
